            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        @can('post-jobs')
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('jobs.new') }}">New job</a>
                        </li>
                        @endcan
                        @can('edit-users')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="adminDropdown">
                                <a class="dropdown-item" href="{{ route('users.notApproved') }}">New users</a>
                                <a class="dropdown-item" href="{{ route('users.listTrashed') }}">Spam</a>
                                </div>
                            </li>
                        @endcan
                    </ul>
